 ...
 * <p>2009-08-05 Daniel Senff -- Access to coordinates of the drop.</p>
 *
 * @author  Robert Harder
 * @author  rharder@users.sf.net
 * @version 1.0.2
 * 
 * Daniel Senff: Added a way to get the dropCoordinates
 * 
 */
public class FileDrop
{
				...
				{   
					...
					{   // Get whatever was dropped
						...
						if (tr.isDataFlavorSupported (java.awt.datatransfer.DataFlavor.javaFileListFlavor))
						{
							...
							if( listener != null ) {
								listener.filesDropped( files, evt.getLocation() );
							}
						...
						else // this section will check for a reader flavor.
						{
							...
							for (int zz = 0; zz < flavors.length; zz++) {
								if (flavors[zz].isRepresentationClassReader()) {
									...
									if(listener != null)
										listener.filesDropped(createFileArray(br, out), evt.getLocation());
	...
	{   
		 ...
		 * @since 1.0
		 */
		public abstract void filesDropped( java.io.File[] files, Point location );
